...
UProjectilePlayer::UProjectilePlayer(float damage, int cnt) : UProjectile(damage, ETypeProjectile::ETP_Projectile)
{
...
UProjectilePlayer::~UProjectilePlayer()
{
    delete[] HitEnemyList;
}
void UProjectilePlayer::CollisionCheck(UGameManager* GameManager)
{
    if (IsActive() == false)
        return;
